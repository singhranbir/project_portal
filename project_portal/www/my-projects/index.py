"""
www/my-projects/index.py
Context for /my-projects/<project-name> detail page.
"""
...
def get_context(context):
	...
	# Extract project name from URL: /my-projects/<name>
	...
	if project_name:
		...
		if not frappe.db.exists("Project", project_name):
			frappe.local.flags.redirect_location = "/my-projects"
			raise frappe.Redirect
